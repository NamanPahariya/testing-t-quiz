...
const QuizPage = () => {
  ...
  useEffect(() => {
    ...
    const isWakeLockAPI = 'wakeLock' in navigator;
    setIsWakeLockSupported(isWakeLockAPI);

    // For iOS/Safari fallback, we'll use a video-based approach
    if (!isWakeLockAPI) {
      // Create a silent video element that keeps playing
      const video = document.createElement('video');
      video.setAttribute('playsinline', '');
      video.setAttribute('src', 'data:video/mp4;base64,');
      video.muted = true;
      video.loop = true;
  ...
  const requestWakeLock = async () => {
    try {
      if (isWakeLockSupported) {
        ...
        // Fallback for iOS/Safari: start playing the silent video
        try {
    ...
    const client = new Client({
      ...
      onConnect: async () => {
        console.log("Connected to WebSocket");
         // Request wake lock when quiz starts
